...
function displayOrPopup(topic)
{
	...
	{
	    win = window.open( 'ADPMainFrame.html?initial=' + topic, '_blank', 'width=800,height=800,resizable=yes,toolbar=yes,status=no,scrollbars=yes,menubar=yes,directories=no,location=no', false);
	    win.focus();
	}
}
